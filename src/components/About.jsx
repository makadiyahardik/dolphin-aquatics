...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-32 overflow-hidden" style={{ background: theme.background }}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <span style={{ color: theme.primary }} className="text-sm font-semibold tracking-widest uppercase">
            Our Legacy
          </span>
