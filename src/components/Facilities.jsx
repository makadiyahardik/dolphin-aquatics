...
const facilities = [
  { title: "Olympic-Size Pool", description: "World-class 50m swimming pool meeting international standards at CSE", icon: "pool", features: ["50m Competition Pool", "Temperature Controlled", "Electronic Timing"], image: "/media/pool-main.jpg" },
  { title: "Training Pool", description: "25m training pool for beginners and intermediate swimmers", icon: "pool2", features: ["25m Training Pool", "Learn to Swim", "Stroke Development"], image: "/media/pool-2.jpg" },
...
const icons = {
  ...
  pool2: <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" /></svg>,
